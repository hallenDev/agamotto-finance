...
const DApp = () => {
  ...
  const [rune, setRune] = useState("Green");
  const [runeColor, setRuneColor] = useState("#5AFE6C");
  ...
  const selectRune = e => {
    ...
    if (runeType === 'Green') {
      setRuneColor("#5AFE6C");
    } else if (runeType === 'Orange') {
      setRuneColor("#F0951D");
    } else if (runeType === 'White') {
      setRuneColor("white");
    }
  }
        ...
        <div className="row">
          <div className="col-sm-8 d-flex align-items-center">
            <div>
              ...
              <p className='fw-normal fs-5'>You can view, manage, and launch your Agamotto Runes from this panel. You can also see how many distributed rewards you have and claim them here. If you then want, you can use them to create more Agamotto Runes, up to a maximum of 100 per wallet.</p>
              <div className="d-flex flex-wrap mt-4">
                <div className="token-price fw-bold d-flex flex-wrap align-items-center my-2 me-4">
                  ...
                  <span className='cl-blue'> app.agamotto.finance</span>
                </div>
                <div className="token-price fw-bold my-2">
                  <span className='cl-brown me-2'>Current $AGMT price:</span>
          ...
          <div className="rune-reward-info d-flex align-items-center">
            <div>
              <div className="row my-2">
                <div className='d-flex align-items-center'>
                  <img src="assets/white_rune.png" alt="white_rune" className='runes-img me-2' />
                  <span>White Runes:</span>
              ...
              <div className="row my-2">
                <div className='d-flex align-items-center'>
                  ...
                  <span className='cl-orange'>Orange Runes:</span>
              ...
              <div className="row my-2">
                <div className='d-flex align-items-center'>
                  ...
                  <span className='cl-green'>Green Runes:</span>
          ...
          <div className="dapp-world-map">
            <div className="d-flex flex-row flex-wrap justify-content-between">
              <div className='dapp-rune-info'>
                <div className={rune === 'White' ? "rune-selected dapp-rune-field" : "dapp-rune-field"} id='White' onClick={selectRune}>
                  <img src="assets/white_rune.png" alt="white_rune" className='dapp-rune-img' />
                </div>
                <p className='fw-bold my-2 text-center'><span className='cl-brown'>3 $AGMT</span> Per Rune</p>
                <p className='fw-bold m-0 text-center'>Earn <span className='cl-brown'>0.125 $AGMT</span> per day</p>
              </div>
              <div className='dapp-rune-info'>
                <div className={rune === 'Orange' ? "rune-selected dapp-rune-field" : "dapp-rune-field"} id='Orange' onClick={selectRune}>
                  <img src="assets/orange_rune.png" alt="orange_rune" className='dapp-rune-img' />
                </div>
                <p className='fw-bold my-2 text-center'><span className='cl-brown'>6 $AGMT</span> Per Rune</p>
                <p className='fw-bold m-0 text-center'>Earn <span className='cl-brown'>0.25 $AGMT</span> per day</p>
              </div>
              <div className='dapp-rune-info'>
                <div className={rune === 'Green' ? "rune-selected dapp-rune-field" : "dapp-rune-field"} id='Green' onClick={selectRune}>
                  <img src="assets/green_rune.png" alt="green_rune" className='dapp-rune-img' />
                </div>
                <p className='fw-bold my-2 text-center'><span className='cl-brown'>12 $AGMT</span> Per Rune</p>
                <p className='fw-bold m-0 text-center'>Earn <span className='cl-brown'>0.5 $AGMT</span> per day</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mt-5">
        <div className="row m-0 gx-5">
          <div className="col-md-6 mb-4 d-flex align-items-end">
            <div>
              <p className='m-0'>Create a  Rune with $Agamotto tokens to earn lifetime high-yield $ token rewards.</p>
              <p>Rewards calculations are based on many factors, including the number of runes, rune revenue, token price, and protocol revenue, and they are variable.</p>
              <div className="d-flex mt-4 flex-wrap">
                ...
                >
                  <BsCart4 />
                  <span className='ms-2'>Buy $AGMT</span>
                </a>
                <span className='btn dapp-btn fw-bold w-fit-content my-2'>My $AGMT: {(parseFloat(balance) / ETHUnit).toFixed(3)}</span>
              </div>
            </div>
          </div>
          <div className="col-md-6 mb-4 d-flex align-items-end">
            <div>
              <input type="text" className='rune-name' placeholder='Enter Rune Name' value={name} onChange={(e) => {
                setName(e.target.value);
              }} />
              <p className="my-2 fw-bold">
                Selected Rune: <span style={{ color: `${runeColor}` }}>{rune} Rune</span>
              </p>
              <p>Please approve the contract before creating a Rune if this is your first interaction </p>
              <div className="d-flex mt-4 flex-wrap">
                {
                  (approved === false) ? (
