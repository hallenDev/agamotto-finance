  ...
  return (
    <React.Fragment>
      ...
      <div className="join-community">
        <div className="container px-5">
          <div className="community-box text-center">
            ...
            <p className='fw-lighter fw-normal'>Then join our Sorcerers on Twitter or Discord and learn more about Agamotto finance.</p>
          </div>
        </div>
      ...
      <div className="footer-bottom">
        <p className='m-0 text-center fs-6 fw-normal'>Copyright &copy; {new Date().getFullYear()} Agamotto finance All rights Reserved</p>
      </div>
    </React.Fragment>
  );
}
